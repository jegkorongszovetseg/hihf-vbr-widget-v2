...
var MjszWidgetElements = function(exports, vue, composables, utils, core, components, icons) {
          ...
          default: vue.withCtx(({ el: rootElement }) => [
            vue.createVNode(vue.unref(components.DataTable), {
              ...
              "cell-broadcast": vue.withCtx(({ row }) => [
                row.broadcast ? (vue.openBlock(), vue.createBlock(vue.unref(icons.IconBroadcast), { key: 0 })) : (vue.openBlock(), vue.createElementBlock("span", _hoisted_6))
              ]),
                ...
                vue.createVNode(vue.unref(components.FloatingPanel), {
                  ...
                  default: vue.withCtx(({ setRef, show }) => [
                    vue.createElementVNode("button", {
                      ...
                      vue.createVNode(vue.unref(icons.IconMore))
                    ], 8, _hoisted_7)
                  ]),
                  content: vue.withCtx(() => [
                    vue.createElementVNode("ul", _hoisted_8, [
                      vue.createElementVNode("li", null, [
                        vue.createElementVNode("a", {
                          ...
                          vue.createVNode(vue.unref(icons.IconSheet), { width: "14" }),
                      ...
                      row.video ? (vue.openBlock(), vue.createElementBlock("li", _hoisted_10, [
                        vue.createElementVNode("a", {
                          ...
                          vue.createVNode(vue.unref(icons.IconYoutube), { width: "14" }),
  ...
  const _sfc_main$1 = {
    ...
    setup(__props) {
      ...
      const currentOffsetName = utils.offsetName(new Date(), vue.unref(timezone), props.locale);
      const convertedRows = vue.computed(() => {
      ...
      const resolveExternalGameLink = (gameId) => utils.externalGameLinkResolver(props.externalGameLink, gameId);
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("div", null, [
