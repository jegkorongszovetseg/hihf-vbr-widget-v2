/*!
  ...
  */
var MjszWidgetElements = function(exports, vue, core) {
  "use strict";
  var _a;
  ...
  const IconSort = /* @__PURE__ */ _export_sfc(_sfc_main$l, [["render", _sfc_render$a]]);
  const _sfc_main$k = {};
  const _hoisted_1$f = {
    "aria-hidden": "true",
    focusable: "false",
  ...
  const IconSortAsc = /* @__PURE__ */ _export_sfc(_sfc_main$k, [["render", _sfc_render$9]]);
  const _sfc_main$j = {};
  const _hoisted_1$e = {
    "aria-hidden": "true",
    focusable: "false",
  ...
  const IconSortDesc = /* @__PURE__ */ _export_sfc(_sfc_main$j, [["render", _sfc_render$8]]);
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("table", {
          ...
          vue.createElementVNode("tfoot", null, [
            __props.rows.length === 0 && !vue.unref(isLoading) ? (vue.openBlock(), vue.createElementBlock("tr", _hoisted_2$b, [
              vue.createElementVNode("td", { colspan: vue.unref(columnCount) }, vue.toDisplayString(vue.unref(t2)("common.noData")), 9, _hoisted_3$a)
            ])) : vue.createCommentVNode("", true),
            vue.unref(isLoadingDebounced) ? (vue.openBlock(), vue.createElementBlock("tr", _hoisted_4$7, [
              vue.createElementVNode("td", { colspan: vue.unref(columnCount) }, vue.toDisplayString(vue.unref(t2)("common.loading")), 9, _hoisted_5$5)
            ])) : vue.createCommentVNode("", true)
          ])
        ], 2);
      };
  ...
  const _hoisted_2$a = /* @__PURE__ */ vue.createElementVNode("path", { d: "M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z" }, null, -1);
  const _hoisted_3$9 = /* @__PURE__ */ vue.createElementVNode("line", {
    x1: "12",
    y1: "9",
    x2: "12",
    y2: "13"
  ...
  function _sfc_render$7(_ctx, _cache) {
    return vue.openBlock(), vue.createElementBlock("svg", _hoisted_1$b, _hoisted_5$4);
  }
  const IconWarning = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["render", _sfc_render$7]]);
  const _sfc_main$f = {
    __name: "ErrorNotice",
    props: {
      error: {
  ...
  const I18NProvider = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["render", _sfc_render$6]]);
  ...
  const IconLeft = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["render", _sfc_render$5]]);
  const _sfc_main$b = {};
  const _hoisted_1$8 = {
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 24 24",
  ...
  const _hoisted_2$7 = /* @__PURE__ */ vue.createElementVNode("polyline", { points: "9 18 15 12 9 6" }, null, -1);
  const _hoisted_3$7 = [
    _hoisted_2$7
  ];
  ...
  const IconRight = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["render", _sfc_render$4]]);
  ...
  const _hoisted_4$5 = ["disabled", "onClick"];
  const _hoisted_5$3 = {
    key: 2,
    class: "is-disabled"
  };
  const _hoisted_6$1 = /* @__PURE__ */ vue.createElementVNode("span", null, "...", -1);
  const _hoisted_7$1 = [
    _hoisted_6$1
  ];
    ...
    setup(__props, { emit }) {
      ...
      return (_ctx, _cache) => {
        return vue.unref(pageCount) > 1 ? (vue.openBlock(), vue.createElementBlock("div", {
          ...
          }, "1", 8, _hoisted_2$6)) : vue.createCommentVNode("", true),
          !__props.isCompact ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_3$6, "...")) : vue.createCommentVNode("", true),
          (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(vue.unref(range), (n2) => {
            ...
            }, vue.toDisplayString(n2), 11, _hoisted_4$5);
          }), 128)),
          !__props.isCompact ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_5$3, _hoisted_7$1)) : vue.createCommentVNode("", true),
          !__props.isCompact ? (vue.openBlock(), vue.createElementBlock("button", {
            key: 3,
            type: "button",
            disabled: vue.unref(page) === vue.unref(pageCount),
            onClick: _cache[2] || (_cache[2] = ($event) => vue.unref(goTo)(vue.unref(pageCount)))
          }, vue.toDisplayString(vue.unref(pageCount)), 9, _hoisted_8$1)) : vue.createCommentVNode("", true),
          vue.createElementVNode("button", {
            type: "button",
            disabled: vue.unref(page) === vue.unref(pageCount),
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("div", {
          ...
          (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(vue.unref(timezoneCountries), (country) => {
            ...
            }, vue.toDisplayString(vue.unref(t2)(`common.${country.countryLabelKey}`)) + " (" + vue.toDisplayString(country.zoneOffsetName) + ") ", 11, _hoisted_1$6);
          }), 128))
        ], 2);
      };
    }
  };
  const _hoisted_1$5 = { class: "is-portrait-image" };
  ...
  const _sfc_main$7 = {
    ...
    setup(__props, { emit }) {
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createBlock(_sfc_main$9, null, {
              ...
              __props.isTeamLinked ? {
                ...
                fn: vue.withCtx(({ row }) => [
                  vue.createElementVNode("a", {
                    ...
                    target: "_blank"
                  }, vue.toDisplayString(row.teamName), 9, _hoisted_2$5)
                ]),
                key: "0"
              } : void 0,
              __props.isPlayerLinked ? {
                ...
                fn: vue.withCtx(({ row }) => [
                  vue.createElementVNode("a", {
                    ...
                    target: "_blank"
                  }, vue.toDisplayString(row.name), 9, _hoisted_3$5)
                ]),
                key: "1"
              } : void 0
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("div", null, [
          vue.createVNode(vue.unref(I18NProvider), { locale: vue.unref(locale) }, {
            default: vue.withCtx(() => [
              vue.unref(hasError) ? (vue.openBlock(), vue.createBlock(vue.unref(_sfc_main$f), {
                key: 0,
  ...
  const _sfc_main$1 = {
    ...
    setup(__props) {
      const props = __props;
      const { onError } = useError();
      const { columns, error } = useColumns(core.COLUMNS_SCHEDULE, props.hideColumns, { offsetName: props.offsetName });
      if (error.value)
        onError(
          new WidgetError(UndefinedColumn.message, {
            ...UndefinedColumn.options,
      ...
      const { t: t2 } = useI18n();
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createBlock(vue.unref(_sfc_main$9), null, {
          default: vue.withCtx(({ el: rootElement }) => [
            vue.createVNode(vue.unref(_sfc_main$h), {
              ...
              "cell-homeTeamLogo": vue.withCtx(({ row }) => [
                (vue.openBlock(), vue.createBlock(vue.unref(_sfc_main$d), {
              ...
              "cell-gameResultType": vue.withCtx(({ row }) => [
                row.isOvertime ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_3, vue.toDisplayString(vue.unref(t2)("common.overtimeShort")), 1)) : vue.createCommentVNode("", true),
                row.isShootout ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_4, vue.toDisplayString(vue.unref(t2)("common.shootoutShort")), 1)) : vue.createCommentVNode("", true),
  ...
  const _sfc_main = {
    ...
    setup(__props) {
      ...
      const rows = vue.computed(() => sortGames(rawRows.value));
      ...
      const timezone2 = vue.ref(getLocalTimezone());
      const currentOffsetName = offsetName(new Date(), vue.unref(timezone2), props.locale);
      const convertedRows = vue.computed(() => {
        return convert(vue.unref(rows)).filter(props.teamFilterByName, ["homeTeamName", "awayTeamName"]).schedule(vue.unref(timezone2), vue.unref(locale)).pagination(vue.unref(page), props.limit).value();
      });
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("div", null, [
          vue.createVNode(vue.unref(I18NProvider), {
            locale: props.locale
          }, {
            default: vue.withCtx(() => [
              vue.unref(hasError) ? (vue.openBlock(), vue.createBlock(vue.unref(_sfc_main$f), {
              ...
              __props.timezoneSelector ? (vue.openBlock(), vue.createBlock(vue.unref(_sfc_main$8), {
                key: props.locale,
                locale: props.locale,
                "current-zone": timezone2.value,
