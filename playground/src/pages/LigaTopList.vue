...
const statisticResolver = `LigaStatistics?report={id}`;
</script>
...
mjsz-vbr-top-list-liga {
  --vbr-widget-link-color: var(--vbr-widget-primary-color-100);
  --vbr-widget-hover-color: var(--vbr-widget-primary-color-0);
}
</style>
